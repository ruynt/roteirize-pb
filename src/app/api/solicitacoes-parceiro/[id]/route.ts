      ...
      if (solicitacao.status !== "APROVADO") {
        ...
        await prisma.place.create({
          data: {
            ...
            mainImageUrl: solicitacao.mainImageUrl,
            mainImagePublicId: solicitacao.mainImagePublicId,
            galleryImageUrls: solicitacao.galleryImageUrls,
            galleryImagePublicIds: solicitacao.galleryImagePublicIds,
            approved: true,
